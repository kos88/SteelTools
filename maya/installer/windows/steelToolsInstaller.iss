...
[Files]
Source: "..\..\..\..\releases\maya\*"; DestDir: "{userdesktop}\steelTools"; Flags: recursesubdirs; Excludes: "__pycache__\*";
...
procedure CurStepChanged(CurStep: TSetupStep);
  begin
    if CurStep = ssPostInstall then begin
      if IsComponentSelected('maya2023') then begin
        // Write the module file data inside text
        bin_text := install_dir + '/bin'
      ...
      if IsComponentSelected('maya2024') then begin
        // Write the module file data inside text
        bin_text := install_dir + '/bin'
      ...
      if IsComponentSelected('maya2025') then begin
        // Write the module file data inside text
        bin_text := install_dir + '/bin'
